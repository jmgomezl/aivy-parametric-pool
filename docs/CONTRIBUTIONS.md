...
| **[hak-uniswap-plugin](HAK-UNISWAP.md)** · prior npm release + new quote tool | Uniswap swap tools for Hedera Agent Kit developers, distributed through npm. | GitHub 0.2.0 adds `uniswap_quote` on September 5; Quorum uses it for Base/Unichain. [Event diff](https://github.com/jmgomezl/hak-uniswap-plugin/compare/77e001e588b524930369f1eab30858a3c81d5d49...05bdc45ec1dbe6b142132dd1e81d6cec8457a58e). Sepolia execution uses Quorum's guarded adapters. [Call site](../src/settlement/crossAsset.js#L65) · [233 npm downloads, dated snapshot](evidence/hak-uniswap-package.json) |
