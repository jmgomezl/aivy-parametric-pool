...
## 0:20–0:34 · A promise made before the earthquake
...
## 0:53–1:17 · Create real testnet cover
...
## 1:17–1:39 · The agent pays for evidence
...
## 2:05–2:19 · Authority is deliberately limited

*Confident and factual. Do not suggest that separate keys mean independent operators.*

An AI model cannot authorize a payout. The workflow is deterministic, with spending limits and saved transaction IDs. In this control, even all three oracle keys could not spend without the agent.

## 2:19–2:52 · Why Axelar and Uniswap
...
## 2:52–3:05 · Two pools, two purposes
...
## 3:05–3:21 · An honest business model
...
The goal is simple: less uncertainty when people need help. A promise you can actually verify.
