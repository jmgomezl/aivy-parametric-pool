...
const proofs={
 ...
 11:[['Ask Quorum','https://quorum.aivylabs.xyz/'],['Recorded companion answer','companion-evidence.json'],['Read-only architecture','https://github.com/jmgomezl/aivy-parametric-pool/blob/main/docs/COMPANION.md']],
