...
export function BridgeTransfer(){
 ...
 return <details className="testnet-swap"><summary>Move aUSDd to Sepolia <span>Axelar ↗</span></summary><div className="testnet-swap-body"><div className="conversion-top"><span>Hedera testnet → Sepolia</span><span>No cash value</span></div><p>Your aUSDd is locked on Hedera; the linked aUSDd token is delivered to your EVM wallet. This does not convert it into USDC.</p>
