...
export function PoliciesPage(){
  ...
  return <div className="page"><div className="page-inner policies-page">
    ...
    {funding?<><FundPool/><h2 className="funding-explore-heading">Explore policy economics</h2><p className="funding-note">These per-policy positions are estimates, not separate vaults. Your real deposit above backs the shared pool.</p></>:null}
