...
export function PoliciesPage(){
  ...
  return <div className="page"><div className="page-inner policies-page">
    ...
    <div className="position-tabs policy-view-tabs" aria-label="Policy view"><button aria-pressed={!funding} onClick={()=>setView(false)}>Cover NFTs</button><button aria-pressed={funding} onClick={()=>setView(true)}>Fund cover</button></div>
