...
import { QuorumCompanion } from './app/QuorumCompanion';
...
export default function App() {
  ...
  if (route.name === 'story') return <><Suspense fallback={<div className="page" role="status">Loading demonstration…</div>}><Story /></Suspense><QuorumCompanion route={route}/></>;
  return (
